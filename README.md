...
[Brian Mumo](https://github.com/brayomumo)
...
* git clone `https://github.com/brayomumo/Proj-awards.git`
* install `python 3.6`
...
Here is a link to the live site https://proawards.herokuapp.com/
